...
public class Main extends StateBasedGame {
	...
	public Main(String gamename) {
		super(gamename);
		this.addState(new MainMenu(stateID.MAIN_MENU.ordinal(), ScreenWidth,
				ScreenHeight));
		this.addState(new levelOne(stateID.MENU_START.ordinal(), ScreenWidth,
				ScreenHeight));
		this.addState(new MenuLevel(stateID.MENU_LEVEL.ordinal(), ScreenWidth,
				ScreenHeight));
		this.addState(new MenuCredit(stateID.MENU_CREDIT.ordinal(),
				ScreenWidth, ScreenHeight));
		this.addState(new MenuHelp(stateID.MENU_HELP.ordinal(), ScreenWidth,
				ScreenHeight));
	...
	public static void main(String[] args) {
		...
		try {
			...
			app.setVSync(true);
			app.setMinimumLogicUpdateInterval(logicInterval);
			app.setMaximumLogicUpdateInterval(logicInterval);
